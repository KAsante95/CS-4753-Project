	...
	*/
	...
	if(verify_nonce()){
		if(isset($_POST['markFlow']) && $_POST['markFlow'] == "true"){ //Proceed to Checkout or Mark flow
        		...
        		$expressCheckoutArray['transactions'][0]['amount']['details']['subtotal'] = $_POST['service_price'];
        		$expressCheckoutArray['transactions'][0]['item_list']['items'][0]['price'] = $_POST['service_price'];
        		...
        		$expressCheckoutArray['transactions'][0]['amount']['total'] = $_POST['service_price'];
